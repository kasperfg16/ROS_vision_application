...
output = subprocess.run("roslaunch ur_description vision_application_bringup.launch", shell=True).stdout
if output == "Robot connected to reverse interface. Ready to receive control commands.":
